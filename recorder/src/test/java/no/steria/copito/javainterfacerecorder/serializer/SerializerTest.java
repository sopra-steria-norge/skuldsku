...
public class SerializerTest {
    ...
    public void shouldReturnClassNameForEmptyClass() throws Exception {
        assertThat(serializer.asString(new EmptyClass())).isEqualTo("<no.steria.copito.javainterfacerecorder.serializer.EmptyClass>");
    }
    ...
    public void shouldParseSimpleStringField() throws Exception {
        ...
        assertThat(serializer.asString(simpleFields)).isEqualTo("<no.steria.copito.javainterfacerecorder.serializer.ClassWithSimpleFields;stringval=pedro;intval=0>");
    }
    ...
    public void shouldHandleControlCharacters() throws Exception {
        ...
        assertThat(serialized).isEqualTo("<no.steria.copito.javainterfacerecorder.serializer.ClassWithSimpleFields;stringval=a&amp&semi&lt&gtbc;intval=0>");
